I’m sorry to hear that. Let’s fix it. I’ll output a plain-text version (with minimal HTML) that *definitely works* when pasted into `README.md`. Copy this carefully, replacing any existing content.
